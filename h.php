                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="block p-0 m-0">
                            <div class="title pl-2 pt-2"><strong>Prehľad hodín - <?= name($_SESSION['id']) ?></strong>
                            </div>
                            <div class="row months mb-2 float-right d-print-none pr-4">
                                <? for ($i = -3; $i <= 0; $i++) { ?>
                                    <a href="<?= $url . 'hodiny/' . $id; ?><?= date('m', strtotime("$i month")) ?>"
                                       role="button"
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm">
                                    ...
                                    foreach (group_by(att_get($table, 'day ASC, start ASC', $_SESSION['id'], $m), array('id', 'day', 'month', 'year')) as $att) {
                                        ...
                                        <a href="https://dochadzka.diago.sk/hodiny-edit/' . $g['uid'] . '" role="button" class="btn btn-success btn-sm mr-1" name="delete"><span class="d-none d-sm-block mr-1">Upraviť</span>
                                ...
                                <table class="table table-sm mt-2">
                                    ...
                                    echo $trd . $tt . '</td><td>' . ht(abs(($h_spolu - wh_month($y, $m)))) . '</td></tr>';
                                    ...
                                    echo ($dov) ? ($trd . 'Dovolenka</td><td colspan="2">' . htd($dov) . ' dní</td></tr>') : ('');
